export default function Success() {
    return (
    <div class="article" id="terms-conditions">
        ...
        <p><strong>Looking for a Privacy Policy?</strong> Check out <a href="https://www.privacypolicygenerator.info" rel="noopener noreferrer">Privacy Policy Generator</a>.</p>
